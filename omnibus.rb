#
# This file is used to configure the fluentd-logcatcher project. It contains
...
# permissions in most cases. You will also need to update the fluentd-logcatcher
